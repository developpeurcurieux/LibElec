...
create table LigneCommande (
   ...
   ligPrix              FLOAT             NOT NULL,
   ligTva               FLOAT             NOT NULL,
   ligReduction         FLOAT                 NULL,
...
create table Promotion (
   ...
   proReduction        FLOAT				NULL,
   proImage            VARCHAR(50)				NULL,
   proStatut           INT                  NOT NULL,
